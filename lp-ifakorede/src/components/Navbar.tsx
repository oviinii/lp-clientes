    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        <a
          ...
          aria-label="Bàbáláwo Ifákọ́rẹ̀dé — início"
        >
          Ifákọ́rẹ̀dé
        ...
        <a
          ...
          className="hidden rounded-full border border-brass/40 px-5 py-2 font-sans text-xs uppercase tracking-[0.22em] text-brass transition hover:border-brass hover:bg-brass hover:text-ink md:inline-flex"
        >
          Agendar jogo
        </a>
          ...
          <ul className="flex flex-col px-6 py-4">
            ...
            <li>
              <a
                ...
                rel="noreferrer noopener"
                onClick={() => setOpen(false)}
                className="mt-4 inline-flex w-full justify-center rounded-full border border-brass px-5 py-3 font-sans text-xs uppercase tracking-[0.22em] text-brass hover:bg-brass hover:text-ink"
              >
                Agendar jogo
              </a>
            </li>
