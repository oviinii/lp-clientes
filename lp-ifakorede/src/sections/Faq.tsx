    ...
    <section id="faq" className="relative bg-ink py-24 lg:py-32">
      <div className="mx-auto max-w-4xl px-6">
        <Reveal>
          ...
          <h2 className="mt-6 text-center font-display text-4xl text-bone sm:text-5xl">
            Perguntas <span className="italic text-goldsoft">de quem chega.</span>
          </h2>
        </Reveal>
              ...
              <Reveal key={f.question} delay={i * 0.05}>
                <div
                  className={`rounded-2xl border transition-colors ${
                    isOpen ? 'border-brass/40 bg-ink-2' : 'border-line bg-ink-2/60'
                  }`}
                >
                  <button
                    type="button"
