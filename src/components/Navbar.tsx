    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <a
          ...
          className="hidden rounded-full bg-volt px-5 py-2 font-sans text-xs font-semibold uppercase tracking-[0.22em] text-ink transition hover:bg-bone md:inline-flex"
        >
          Orçamento
        </a>
          ...
          <ul className="flex flex-col px-6 py-4">
            ...
            <li>
              <a
                ...
                rel="noreferrer noopener"
                onClick={() => setOpen(false)}
                className="mt-4 inline-flex w-full justify-center rounded-full bg-volt px-5 py-3 font-sans text-xs font-semibold uppercase tracking-[0.22em] text-ink"
              >
                Pedir orçamento
              </a>
            </li>
