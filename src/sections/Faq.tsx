...
export function Faq() {
  ...
  return (
    <section id="faq" className="relative bg-ink-3 py-24 lg:py-32">
      <div className="mx-auto max-w-4xl px-6">
        <Reveal>
          ...
          <h2 className="mt-6 text-center font-display text-4xl font-bold tracking-tight text-bone sm:text-5xl">
            Antes de <span className="text-volt">chamar.</span>
          </h2>
        </Reveal>
              ...
              <Reveal key={f.question} delay={i * 0.05}>
                <div
                  className={`rounded-2xl border transition-colors ${
                    isOpen ? 'border-volt/40 bg-ink-2' : 'border-line bg-ink-2/60'
                  }`}
                >
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <Plus
                      size={18}
                      className={`shrink-0 text-volt transition-transform duration-300 ${
                        isOpen ? 'rotate-45' : ''
                      }`}
                    />
                  </button>
