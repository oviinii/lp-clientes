...
export function Steps() {
  return (
    <section id="passos" className="relative bg-ink-3 py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <Reveal>
          ...
          <h2 className="mt-6 font-display text-4xl font-bold leading-tight tracking-tight text-bone sm:text-5xl">
            Funil de <span className="text-lime">matrículas.</span>
          </h2>
          <p className="mt-4 max-w-3xl font-sans text-base leading-relaxed text-bone-dim">
